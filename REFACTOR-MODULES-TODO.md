...
| --- | ------------------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- |
| 1   | 02 — Purchase Order | `features/purchase-order/` | Bước 1–9 xong. schemas/lifecycle/api/queries/mutations/selectors/components/action-gating/loading-error/URL filters(search+status)/a11y(aria-label, htmlFor)/validate pass. localStorage giữ layout prefs (showStats, columns, columnSearch, searchFields). | —   |
| 2   | 03 — Receipt        | `features/receipt/`        | Chưa bắt đầu                                                                                                                                                                                                                                                | —   |
