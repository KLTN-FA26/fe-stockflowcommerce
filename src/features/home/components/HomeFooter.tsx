...
export function HomeFooter() {
  ...
  return (
    <footer className="border-border-default bg-bg-base/70 shrink-0 border-t backdrop-blur-xl">
      <div className="text-ink-tertiary mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-3 text-xs sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button
            ...
            className="border-border-default bg-bg-surface/70 text-ink-primary hover:bg-bg-muted hover:text-ink-primary size-8 shrink-0 rounded-[var(--r-sm)] border"
          >
